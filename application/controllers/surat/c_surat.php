...
class C_surat extends CI_Controller {
    ...
    function load_data() {
		...
		<button data-toggle="modal" href="#dialog-print" type="submit" class="btn btn-primary btn-xs" title="Cetak Surat" onclick="cetak(\''.$row->id_surat.'\')"/><i class="fa fa-print"></i></button>
		'
			);  
		}
		//Print please
