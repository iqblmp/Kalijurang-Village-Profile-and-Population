...
<div class="row">
    <div class="col-md-6">
        <h3>Selamat Datang <b>Pengelola Data Kalijurang </b></h3>
        <legend></legend>
    </div>
    <div class="col-md-6">
    ...
    <div class="col-md-12">
        <a href="<?php echo site_url('datapenduduk/c_keluarga/add'); ?>">
            <button type="button" class="btn btn-warning"><i class="fa fa-plus-square fa-fw"></i> Tambah Kepala Keluarga</button>
        </a>
        <a href="<?php echo site_url('datapenduduk/c_keluarga/'); ?>">
            <button type="button" class="btn btn-warning"><i class="fa fa-list fa-fw"></i> Daftar Data Kepala Keluarga</button>
        </a>
    </div>
</div>
<br>
