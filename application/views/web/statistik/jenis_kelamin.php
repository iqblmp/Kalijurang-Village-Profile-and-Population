				...
				<div class="row">
					<div class="col-sm-6">
						<div class="footer-content">
							<h2>SIDEKA</h2>
							<p>Adalah sebuah sistem informasi untuk Desa Kalijurang</p>
							<div class="row">
								<div class="col-md-6">
									<ul class="list-icons">
										<li><i class="fa fa-map-marker pr-10"></i> Jl. Kalijurang, Brebes</li>
										<li><i class="fa fa-phone pr-10"></i> +62 800000</li>
										<li><i class="fa fa-envelope-o pr-10"></i>sidekalijurang@mail.com</li>
									</ul>
								</div>
		...
		$(function() {
			...
			$(document).ready(function() {
				...
				$('#container').highcharts({
					...
					subtitle: {
						text: 'Menurut Jenis Kelamin Penduduk'
					},
					tooltip: {
					...
					series: [{
						...
						data: [
							['Laki-laki', <?php echo $dataL ?>],
							['Perempuan', <?php echo $dataP ?>]
						]
					}]
				});
			});
